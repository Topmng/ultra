...
This is separate from binance_fetch.py (historical CSV dumps). It records the
...
depth diffs, and 20-level depth_start + depth_latest snapshots.
    ...
    python fetch_payload.py
    python fetch_payload.py --window-seconds 60 --out examples/env_payload.json
"""
